    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      <div className="w-[90%] mx-auto px-6 lg:px-16 relative z-10">
        ...
        <div className="grid md:grid-cols-12 gap-12 max-w-6xl mx-auto">
          ...
          >
            <Card className="backdrop-blur-sm bg-white/5 border border-white/10 shadow-lg h-full">
              <CardContent className="p-8">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="font-medium text-white hover:text-orange-500 transition-colors hover-target"
                      >
                ...
                <div className="mt-12">
                  ...
                  <div className="flex gap-3">
                    <motion.a
                      ...
                      className="bg-gray-800 p-3 rounded-full hover:bg-gray-700 text-white hover:text-orange-500 transition-all duration-300 hover-target"
                ...
                <div className="mt-12 p-6 bg-gradient-to-br from-orange-900/30 to-orange-900/30 rounded-lg border border-orange-900/30">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Card className="bg-gray-900/50 border-orange-900/30 shadow-lg backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={`bg-gray-800/50 border-gray-700 text-white focus:border-orange-500 focus:ring-orange-500 ${
                  ...
                  >
                    <Button
                      type="submit"
                      className="w-full bg-gradient-to-r from-orange-500 to-orange-500 hover:from-orange-600 hover:to-orange-600 text-white border-none hover-target"
